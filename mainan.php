...
// Ambil produk yang memiliki kategori mainan
$query = "SELECT * FROM products WHERE category = 'mainan' ORDER BY name";
$stmt = $conn->prepare($query);
$stmt->execute();
$mainan_products = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
...
<body>
    ...
    <main>
        <div class="center-text">
            <h2>Mainan Kucing</h2>
            <p>Kasih mainan anabulmu, biar gak mainin perasaan kucing lain</p>
        </div>

        <div class="products">
            <?php foreach ($mainan_products as $product): ?>
                <div class="product">
