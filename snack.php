...
// Ambil produk yang memiliki kategori snack
$query = "SELECT * FROM products WHERE category = 'snack' ORDER BY name";
$stmt = $conn->prepare($query);
$stmt->execute();
$snack_products = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
...
<body>
    ...
    <main>
        <div class="center-text">
            <h2>Snack Miawwwwww</h2>
            <p>Temukan berbagai pilihan Snack kucing yang lezat, bikin anabulmu ketagihan</p>
        </div>

        <div class="products">
            <?php foreach ($snack_products as $product): ?>
                <div class="product">
