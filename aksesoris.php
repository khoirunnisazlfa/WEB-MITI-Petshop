...
// Ambil produk yang memiliki kategori aksesoris
$query = "SELECT * FROM products WHERE category = 'aksesoris' ORDER BY name";
$stmt = $conn->prepare($query);
$stmt->execute();
$aksesoris_products = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
...
<body>
    ...
    <main>
        <div class="center-text">
            <h2>Aksesoris Kucing</h2>
            <p>Bikin ketjeh anabulmu dengan membelikannya aksesoris yang lagi ngehits</p>
        </div>

        <div class="products">
            <?php foreach ($aksesoris_products as $product): ?>
                <div class="product">
