...
// Ambil produk yang memiliki kategori pakaian
$query = "SELECT * FROM products WHERE category = 'pakaian' ORDER BY name";
$stmt = $conn->prepare($query);
$stmt->execute();
$pakaian_products = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
...
<body>
    ...
    <main>
        <div class="center-text">
            <h2>Pakaian Kucing</h2>
            <p>Beliin anabul kamu pakaian, biar auratnya gak keumbar kemana mana</p>
        </div>

        <div class="products">
            <?php foreach ($pakaian_products as $product): ?>
                <div class="product">
                    ...
                    <!-- Perubahan: Mengubah URL ke payment_method.php dan menambahkan parameter produk -->
